...
class GoBindingsPacket(c_common.GoPacket):
...
class GoBindingsGenerator(common.BindingsGenerator):
    ...
    def generate(self, device):
        ...
        c = open(os.path.join(self.get_bindings_root_directory(), 'bindings', filename + '.go'), 'wb')
